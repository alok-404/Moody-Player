...
const Songlist = ({ songs }) => {
  ...
  return (
    <div className="bg-zinc-800 rounded-xl p-4 h-full shadow-md">
      ...
      <div className="max-h-[550px] overflow-y-auto space-y-4 pr-2 custom-scroll">
        {Array.isArray(songs) && songs.length > 0 ? (
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <button
                  ...
                  className="w-12 h-12 flex items-center justify-center rounded-full bg-orange-600 text-white shadow-lg text-lg hover:scale-105 transition-all"
                >
                  {currentSongIndex === index && isPlaying ? "⏸" : "▶"}
                </button>
              </div>
          ...
          <p className="text-zinc-400 text-sm text-center py-20 italic">
